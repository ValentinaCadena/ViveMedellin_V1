...
const Button = ({
  ...
  const colorClass =
    color === "blue"
      ...
      : color === "blue2"
      ? "bg-white text-darkBlue hover:text-white hover:bg-darkBlue border-transparent rounded-lg p-2 px-4 gap-2 font-semibold text-base"
      : color === "roundedBlue"
      ? "bg-white text-darkBlue hover:text-white hover:bg-darkBlue border-transparent rounded-full font-semibold text-base"
      : color === "orange"
