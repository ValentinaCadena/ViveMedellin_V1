...
export default function Sidebar () {
    return (
        <div className="max-w-100 space-y-4 border-r-2 border-Gray ml-4 pr-2 pt-2">
            <h1 className="text-3xl text-Blue font-bold">Grupos y comunidades</h1>
            <input type="text" id="text" name="busqueda" placeholder="Buscar Grupos" className="border-black"/>
