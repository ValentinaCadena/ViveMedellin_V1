...
export default function Home () {
  ...
  return (
    <div className="flex flex-col gap-12 h-screen justify-center items-center">
      ...
      <Button text="Ingresar a la plataforma" icon="material-symbols:groups" color="blue" className="text-5xl gap-8" widthIcon="96" onClick={() => router.push('/busquedaGrupos')}></Button>
    </div>
  )
}